...
?> <?php } ?><tr>  
   ...
   <div class="col-md-6">
                        ...
                        <input type="text" placeholder="" class="form-control" name="email" id="email" required="required" value="<?php echo $row['email'];?>" />
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="telefone" required="required" id="telefone" value="<?php echo $row['telefone'];?>" />
